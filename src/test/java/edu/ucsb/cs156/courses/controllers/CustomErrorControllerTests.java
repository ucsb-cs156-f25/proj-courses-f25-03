...
public class CustomErrorControllerTests extends ControllerTestCase {
    ...
    public void testHandleError_404() throws Exception {
        ...
        MvcResult response = mockMvc.perform(get("/error")
                ...
                .andExpect(model().attribute("message", "The page you are looking for might have been removed or is temporarily unavailable"))
                .andReturn();
    }
    ...
    public void testHandleError_403() throws Exception {
        ...
        MvcResult response = mockMvc.perform(get("/error")
                ...
                .andExpect(model().attribute("message", "You don't have permission to access this resource"))
                .andReturn();
    }
    ...
    public void testHandleError_500() throws Exception {
        ...
        MvcResult response = mockMvc.perform(get("/error")
                ...
                .andExpect(status().isOk())
                .andExpect(view().name("error"))
                .andExpect(model().attributeExists("status", "error", "message", "exceptionMessage", "stackTrace", "timestamp", "path"))
